...
--
-- Table structure for table `urgent_sales`
--

DROP TABLE IF EXISTS `urgent_sales`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `urgent_sales` (
  `urgent_sale_id` int NOT NULL AUTO_INCREMENT,
  `farmer_id` int NOT NULL,
  `product_name` varchar(100) NOT NULL,
  `description` text,
  ...
  PRIMARY KEY (`urgent_sale_id`),
  KEY `farmer_id` (`farmer_id`),
  CONSTRAINT `urgent_sales_ibfk_1` FOREIGN KEY (`farmer_id`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `urgent_sales`
--

LOCK TABLES `urgent_sales` WRITE;
/*!40000 ALTER TABLE `urgent_sales` DISABLE KEYS */;
/*!40000 ALTER TABLE `urgent_sales` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `urgent_sale_reservations`
--

DROP TABLE IF EXISTS `urgent_sale_reservations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `urgent_sale_reservations` (
  `reservation_id` int NOT NULL AUTO_INCREMENT,
  `urgent_sale_id` int NOT NULL,
  `buyer_id` int NOT NULL,
  `quantity` int NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`reservation_id`),
  KEY `urgent_sale_id` (`urgent_sale_id`),
  KEY `buyer_id` (`buyer_id`),
  CONSTRAINT `urgent_sale_reservations_ibfk_1` FOREIGN KEY (`urgent_sale_id`) REFERENCES `urgent_sales` (`urgent_sale_id`),
  CONSTRAINT `urgent_sale_reservations_ibfk_2` FOREIGN KEY (`buyer_id`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `urgent_sale_reservations`
--

LOCK TABLES `urgent_sale_reservations` WRITE;
/*!40000 ALTER TABLE `urgent_sale_reservations` DISABLE KEYS */;
/*!40000 ALTER TABLE `urgent_sale_reservations` ENABLE KEYS */;
UNLOCK TABLES;
